...
public class PendulumRunner {
    ...
    public static void main (String [] args) {
    	...
    	GravityConstant Gravity = new GravityConstant(9.80665);
    	...
    	RegularPendulum rpCoarse = new RegularPendulum (sLen, pMass, theta0, .1, Gravity);

    	// print out difference in displacement in 1 second intervals for 10 seconds
